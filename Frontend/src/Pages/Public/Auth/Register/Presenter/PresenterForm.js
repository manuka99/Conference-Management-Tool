    ...
    <>
      ...
      <CardActionArea>
        <CardMedia
          ...
          height="200"
          width="200"
          image="/static/images/presenter.jpg"
          title="presenter"
        />
        <CardContent>
          ...
          <Typography variant="body2" color="textSecondary" gutterBottom>
            Presenter is the practical implementation of ideas that result in
            the introduction of new goods or services or improvement in offering
            goods or services. ISO TC 279 on presenter management proposes in
            the standards, ISO 56000:2020 to define presenter as "a new or
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="textSecondary" gutterBottom>
          Presenter is the practical implementation of ideas that result in the
